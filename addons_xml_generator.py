...
class Generator:
    ...
    def _generate_addons_file( self ):    
        ...
        for repository in os.listdir( "." ):
            if not os.path.isdir(repository) or repository =='.git': 
                continue
            addons = os.listdir(os.path.join(os.path.dirname(__file__),repository))
            print 'found repository',repository
            ...
            for addon in addons:
                ...
                try:
                    ...
                    if ( not os.path.isdir( addon_path ) or addon == ".git" or addon in addons_ignore): continue
                    # create path
                    _path = os.path.join( addon_path, "addon.xml" )
